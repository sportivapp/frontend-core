<template>
  <v-row align="center" class="author-summary" justify="start">
    ...
    <v-col align="start">
      ...
      >
        <span class="author-summary__identity--bold" :title="author.eusername">
          {{ author.eusername }}
        </span>
        &nbsp;dari&nbsp;
        <span class="author-summary__identity--bold" :title="company.ecompanyname">
          {{ company.ecompanyname }}
        </span>
      </v-row>
      <v-row>
        <span
